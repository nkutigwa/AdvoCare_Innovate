...
<script>
  (function(){
	...
	============================-->
		...
		<section>
			<div class="container-fluid myheader page-sector">
				<div class="my-header-title">Activities Sectors</div>
			</div>
		</section>

		<section>
			<div class="container-fluid content">
				At AdvoCare Innovate, we use innovative research and evaluation techniques to assist decision makers in a wide of range of sectors including finance, agriculture, health, Nutrition, water and sanitation, gender, family, education, social services, climate change, transportation, capacity building, community integration, etc.			</div>
		</section>
