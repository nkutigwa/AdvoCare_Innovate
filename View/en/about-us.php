	...
	<main id="main">
		...
		<section>
			<div class="container-fluid myheader">
				<div class="my-header-title">Profile of ADCI</div>
			</div>
		</section>

		<section>
			<div class="container-fluid content">
				The AdvoCare Innovate is an entity that conducts surveys, studies, research and training across the African continent. Our multidisciplinary team of seasoned African experts, with extensive country experience and top notch skills, is committed to producing quality data based on international standards for evidence-based policies and operational solutions. We provide insights on a myriad of sectors while taking into account cultural and geostrategic contexts as well as local markets’ maturity.			</div>
		</section>
		
	    <!-- <section id="about" class="about-bg">
	      <div class="container">
	        <div class="row">
	          <div class="col-md-12 col-lg-6 wow fadeInLeft about-us" data-wow-delay="0.1s" data-wow-duration="1.4s" style="margin-bottom: 2rem;">
	            <div class="box">
	              <div class="icon" style="background: rgba(0,176,240,0.3);"><i class="ion-ios-home" style="color: rgba(0,176,240,1);"></i></div>
	              <h4 class="title"><a href="">ADCI</a></h4>
	              <p class="description">The AdvoCare Innovate  is an entity that conducts surveys, studies, research and training across the African continent. Our multidisciplinary team of seasoned African experts, with extensive country experience and top notch skills, is committed to producing quality data based on international standards for evidence-based policies and operational solutions. We provide insights on a myriad of sectors while taking into account cultural and geostrategic contexts as well as local markets’ maturity.</p>
				</div>
	          </div>

	          <div class="col-md-12 col-lg-6">
	            <div class="col-md-12 col-lg-12 wow fadeInRight our-vision" data-wow-delay="0.1s" data-wow-duration="1.4s" style="margin-bottom: 1rem;">
	              <div class="box">
	                <div class="icon" style="background: #e6fdfc;"><i class="ion-ios-eye" style="color: #3fcdc7;"></i></div>
	                <h4 class="title"><a href="">VISION</a></h4>
	                <p class="description">To become a recognized data quality research laboratory across Africa and beyond as well as a long term trusted and valuable partner to all stakeholders.</p>
	              </div>
	            </div>

	            <div class="col-md-12 col-lg-12 wow fadeInUp our-values" data-wow-delay="0.1s" data-wow-duration="1.4s" style="margin-bottom: 1rem; margin-top: 2rem;">
	              <div class="box">
	                <div class="icon" style="background: #eafde7;"><i class="ion-ios-heart" style="color:#41cf2e;"></i></div>
	                <h4 class="title"><a href="">Our values</a></h4>
	                <p class="description">
	                  <b>Integrity</b><br>
	                  A commitment to fostering excellent work ethics, producing quality data and operating in full transparency.	                </p>
	                <p class="description">
	                  <b>Reliability</b><br>
	                  A commitment to scrupulously respecting contractual agreements and meeting clients expectations.	                </p>
	                <p class="description">
	                  <b>Excellence</b><br>
	                  A commitment to producing quality deliverables in a timely manner and being consistently result oriented.	                </p>
	              </div>
	            </div>
	          </div>
	        </div>
		...
		<section>
			<div class="container-fluid partners">
				...
				<div class="partners">
					<img src="../img/uniceflogo.png" alt="" class="img-fluid img-partner">
				<!--hide this content>
					<img src="../img/Chemonics2.png" alt="" class="img-fluid img-partner">
					<img src="../img/WB_logo.png" alt="" class="img-fluid img-partner">
					<img src="../img/dfid.png" alt="" class="img-fluid img-partner">
					<img src="../img/usaid.png" alt="" class="img-fluid img-partner">
					<img src="../img/part1.png" alt="" class="img-fluid img-partner">
					<img src="../img/part2.png" alt="" class="img-fluid img-partner">
					<img src="../img/part3.png" alt="" class="img-fluid img-partner">
                </div> -->
				</div>
			</div>
		</section>
