  ...
  (function(){
	...
	<section>
		<div class="container-fluid myheader">
			<div class="my-header-title">Impact Evaluation and Third Party Monitoring services</div>
		</div>
	</section>
	<section>
		<div class="container-fluid content">
			AdvoCare innovate conducts impact evaluation of projects using several methodologies such as Randomized Control Trial (RCT), Difference in Differences (DD), Propensity Score Matching (PSM), Regression Design (RDD), etc. In addition to the impact evaluation services AdvoCare innovate offers Third Party Monitoring (TPM) services too.		</div>
	</section>
